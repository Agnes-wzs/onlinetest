...
var app = {
	...
	URL : {
		...
		deleteQuestion_contentUrl : function() {
			return app.data.contextPath
					+ "/question/api/deleteQuestion_content/";
		},
		...
		manageResultStudentListUrl : function(contestId) {
			return app.data.contextPath + "/manage/result/contest/" + contestId
					+ "/list";
		},
	...
	convertTime : function(localDateTime) {
		...
		return year + "-" + monthValue + "-" + dayOfMonth + " " + hour + ":"
				+ minute + ":" + second;
	},
	toTimeStamp : function(localDateTime) {
		...
		// console.log("new Date(currTime).valueOf() = " + new
	...
	queryQuestionAction : function() {
		...
		window.location.href = app.URL.manageQuestionUrl() + '?page=1&content='
				+ content;
	}
};